...
public class LDCachingFileBackend implements LDCachingBackend {
    ...
    public CacheEntry getEntry(URI resource) {
        try {
            ...
            try {
                ...
                ModelCommons.add(triples, con.getStatements(null,null,null,true, resource));
    ...
    public void putEntry(URI resource, CacheEntry entry) {
        try {
            ...
            try {
                ...
                con.add(entry.getTriples(), resource);
    ...
    public void initialize() {
        ...
        try {
            cacheRepository = new SailRepository(new NativeStore(tripleDir, "cspo"));
