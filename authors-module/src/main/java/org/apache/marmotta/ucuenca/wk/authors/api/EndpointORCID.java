 ...
 * @author joe
 */
public class EndpointORCID extends EndpointObject {

  public EndpointORCID(String status, String org, String access, String type, String graph, String resourceId) {
