wkhomeControllers.controller('reportService', ['$scope', '$routeParams', 'globalData', 'sparqlQuery', 'StatisticsbyInst', 'searchData', '$route', '$window', 'ServicesService', 'getMetric',
  function ($scope, $routeParams, globalData, sparqlQuery, StatisticsbyInst, searchData, $route, $window, ServicesService, getMetric) {
    var self = this;
    $scope.data = {};
    ...
    getMetric.query({
      ...
      $scope.disservices = {container: "containerservice", "datos": datos};
      $scope.topservices = {container: "containerservice", datos: datosTop};
    });
    ...
    getMetric.query({
      ...
      $scope.serviceuni = {container: "containerseruni", "datos": datos};
    });
