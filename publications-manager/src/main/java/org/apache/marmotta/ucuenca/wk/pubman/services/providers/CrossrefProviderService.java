 ...
 * @author José Ortiz
 */
public class CrossrefProviderService extends AbstractProviderService {
    ...
    protected List<String> buildURLs(String firstName, String lastName, List<String> organizations) {
        ...
        String NS_DBLP = "https://search.crossref.org/search/";
    ...
    protected String getProviderGraph() {
        return constantService.getCrossrefGraph();
    }
