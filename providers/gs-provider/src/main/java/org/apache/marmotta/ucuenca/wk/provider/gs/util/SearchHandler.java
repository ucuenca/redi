...
public final class SearchHandler extends DefaultHandler implements IHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (isProfile && DIV.equals(localName)) {
            ...
            if (isPhotoDiv && ANCHOR.equals(localName)) {
                author.updateAuthor(ProfileAttributes.URL, GoogleScholarProvider.SCHOLAR_GOOGLE + attributes.getValue("href"));
            }
            if (isPhotoDiv && IMG.equals(localName)) {
                String img = !attributes.getValue("src").contains("avatar") ? GoogleScholarProvider.SCHOLAR_GOOGLE + attributes.getValue("src") : null;
