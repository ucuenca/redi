 ...
 */
public class DBLPURIMapper extends XPathValueMapper {

	private static String nsEntity;
	
	public DBLPURIMapper(String namespace, String xpath) {
    	super(xpath);
    	nsEntity = namespace;
    }
	
	public DBLPURIMapper(String xpath) {
    	super(xpath);
    }

    public DBLPURIMapper(String xpath, Map<String, String> namespaces) {
