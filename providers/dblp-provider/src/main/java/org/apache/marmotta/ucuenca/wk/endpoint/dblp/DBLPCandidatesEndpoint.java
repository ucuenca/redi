...
/**
 * Endpoint for accessing DBLP Authors Search as RDF.
 *
...
public class DBLPCandidatesEndpoint extends Endpoint {
    ...
    public DBLPCandidatesEndpoint() {
        super(DBLPCandidatesProvider.NAME, DBLPCandidatesProvider.NAME, DBLPCandidatesProvider.PATTERN, null, 86400L);
