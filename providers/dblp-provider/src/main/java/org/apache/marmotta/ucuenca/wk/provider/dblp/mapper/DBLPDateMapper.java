...
/**
 * Date Mapper for date fields!
 * <p/>
 * Author: Santiago Gonzalez
 */
public class DBLPDateMapper extends XPathValueMapper {

    public DBLPDateMapper(String xpath) {
        super(xpath);
    }
    
    public DBLPDateMapper(String xpath, Map<String, String> namespaces) {
