...
public class TestScopusProvider extends ProviderTestBase {
    ...
    /**
     * Tests the Scopus APIs. It looks for an author and checks if the authors
     * has the expected ORCID.
     *
     * @throws Exception
     */
    @Test
    public void testAuthorSearchRightOrcid() throws Exception {
        testResource(
                String.format(templateURL, "authfirst(juan)authlast(carvallo)affil(ecuador)", apiKey),
                "scopus-check-orcid-extraction.sparql");
    }
