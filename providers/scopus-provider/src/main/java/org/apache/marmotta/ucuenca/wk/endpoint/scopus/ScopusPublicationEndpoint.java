...
import org.apache.marmotta.ucuenca.wk.provider.scopus.ScopusPublicationProvider;
...
public class ScopusPublicationEndpoint extends Endpoint {
    ...
    public ScopusPublicationEndpoint() {
        super(ScopusPublicationProvider.NAME, ScopusPublicationProvider.NAME, ScopusPublicationProvider.PATTERN, null, 86400L);
